                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="pariwisata">
                            <div class="timeline-item" id="pariwisata_last"><p>Siapa yang tak kenal <strong><a
                                    ...
                                    merupakan tempat andalan untuk wisata seni dan budaya bahkan alam serta kuliner nya
                                    pun
                                    tak kalah menarik untuk kita bahas. Berikut adalah 7 tempat wisata di jogja yang
                                    paling
                                    populer dan menarik yang bisa anda jadikan referensi jika sedang berkunjung ke
                                    jogja.
                                    Mana saja kah itu ??</p>
                                ...
                                <p><br>
                                    Siapa yang tidak kenal akan kesohoran jalan ini, jogjakarta sudah sangat identik
                                    dengan
                                    jalan malioboro. Jalan yang menghubungkan anda untuk pergi ke keraton ini memang
                                    tidak
                                    pernah sepi. Banyak para pedagang serta penjual kuliner beraneka ragam ada di tempat
                                    ini. Jika anda ingin berkunjung ke jogja malioboro ini bisa di jadikan tempat
                                    pertama
                                    untuk singgah.</p>
                                ...
                                <h3><br>
                                    Untuk Pariwisata alam jogja juga punya pantai cantik nan elok yaitu pantai
                                    indrayanti,
                                    walaupun banyak pantai – pantai cantik di jogjakarta kami sengaja memilihkan pantai
                                    indrayanti untuk tujuan anda karena pemandangan yang indah serta hamparan pasir
                                    putih
                                    yang mengagumkan, walaupun banyak resort serta kios – kios para penjual souvenir di
                                    pantai ini akan tetapi tidak merusak ke alamian dan keindahan wisata pantai
                                    indrayanti
                                    tersebut.</h3>
                            </div>
                            <br>
                        ...
                        <div class="tab-pane" id="perdagangan">
                            <div class="timeline-item" id="perdagangan_last"><p><a
                                            ...
                                            href="http://www.kemendag.go.id/id/newsroom">Berita</a> // Berita
                                    Perdagangan
                                </p>
                                ...
                                <h2>
                                    <a href="http://www.kemendag.go.id/id/news/2017/11/02/tingkatkan-sinergi-dengan-bank-bri-kdei-taipei-tingkatkan-pelayanan-dan-perlindungan-tki-di-taiwan">Tingkatkan
                                        Sinergi dengan Bank BRI, KDEI Taipei Tingkatkan Pelayanan dan Perlindungan TKI
                                        di
                                        Taiwan</a></h2>

                                <p>Kantor Dagang dan Ekonomi Indonesia (KDEI) Taipei terus melakukan berbagai terobosan
                                    dalam meningkatkan pelayanan dan perlindungan Tenaga Kerja Indonesia (TKI) atau
                                    Warga
                                ...
                                <p>Kantor Dagang dan Ekonomi Indonesia (KDEI) Taipei menerima penghargaan dari Chamber
                                    of
                                ...
                                <p>Kantor Dagang dan Ekonomi Indonesia (KDEI) di Taipei kembali menggelar pernikahan
                                    massal
                                    bagi warga negara Indonesia (WNI) di Taiwan. Prosesi pernikahan massal yang diikuti
                                    enam
                                    pasang mempelai <a
                                ...
                                <p>Perwakilan Indonesia di Amerika Serikat (AS) membidik pasar fesyen di Negeri Paman
                                    Sam
                                    untuk mengembangkan potensi ekspor tenun ikat Indonesia. Melalui kegiatan Lokakarya
                                    Ikat
                                    di Los Angeles, AS <a
                                ...
                                <p>Indonesia Trade Promotion Center (ITPC) Los Angeles (LA) menyelenggarakan lokakarya
                                    tas
                                    jinjing (tote bag) batik ramah lingkungan di Chinatown LA, Amerika Serikat (AS),
                                    pada 7
                                ...
                                <p>Lebih dari 2.000 cangkir teh khas Indonesia beragam kreasi habis diserbu pengunjung
                                    dalam
                                ...
                                <h2>
                                    <a href="http://www.kemendag.go.id/id/news/2017/10/18/lokakarya-teh-kreatif-indonesia-di-los-angeles-tradisi-teh-menyatu-dengan-budaya-minum-teh-modern">Lokakarya
                                        Teh Kreatif Indonesia di Los Angeles: Tradisi Teh Menyatu dengan Budaya Minum
                                        Teh
                                        Modern</a></h2>
                                ...
                                <h2>
                                    <a href="http://www.kemendag.go.id/id/news/2017/09/29/produk-alat-kebersihan-dan-produk-kosmetik-sabun-dan-spa-indonesia-sukses-curi-perhatian-di-autumn-f">Produk
                                        Alat Kebersihan dan Produk Kosmetik, Sabun dan Spa Indonesia Sukses Curi
                                        Perhatian
                                ...
                                <p>Sejumlah CEO perusahaan waralaba Indonesia diundang sebagai pembicara dalam lokakarya
                                    bertajuk “Pendampingan Waralaba bagi Diaspora dan Tenaga Magang Indonesia di
                                    Jepang”. <a
                        ...
                        <div class="tab-pane" id="pertanian">
                            <div class="timeline-item" id="pertanian_last"><h3><strong>Petani Inggris Ini Mengubur
                                        Celana
                                        Dalam di Lahannya, Untuk Apa?</strong></h3>

                                <p>&nbsp;</p>

                                <p><strong>Liputan6.com, Moray -</strong> Mengetahui tingkat kesuburan lahan bukan lah
                                    hal
                                    yang mudah untuk dilakukan, apalagi jika iklim di sekitarnya&nbsp;terus mengalami
                                    perubahan. Hal itu membuat para petani harus mengeluarkan dana cukup banyak pada
                                    setiap
                        ...
                        <div class="tab-pane" id="industri">
                            <div class="timeline-item" id="industri_last"><h2><span style="color: #0000ff;">RENCANA STRATEGIS KEMENTERIAN PERINDUSTRIAN</span>
                                ...
                                <p>Renstra Kementerian Perindustrian 2015-2019 dimaksudkan untuk merencanakan kontribusi
                                    yang signifikan bagi keberhasilan pencapaian sasaran pembangunan nasional
                                    sebagaimana
                                    diamanatkan pada Rencana Pembangunan Jangka Menengah Nasional 2015-2019, serta
                                    disusun
                                    ...
                                    paradigma peningkatan daya saing dan kecenderungan pengembangan industri ke
                                    depan.</p>
                        ...
                        <div class="tab-pane" id="pendidikan">
                            <div class="timeline-item" id="pendidikan_last"><h1><span style="color: #ff0000;">Program Studi Sarjana Teknik Industri </span>
                                ...
                                <ul>
                                    <li><strong>Bidang produksi/ operasi dan penjaminan mutu</strong><br> Lulusan TI
                                        sangat
                                    ...
                                    <li><strong>Bidang sistem informasi</strong><br> Posisi yang biasanya diduduki
                                        lulusan
                                        ...
                                        Pertamina, P&amp;G,
                                        dll<em>.</em></li>
                                    <li><strong>Bidang pemasaran</strong><br> Beberapa posisi yang biasanya ditempati
                                        oleh
                                        lulusan TI misalnya&nbsp;<em>market research, technical sales</em>, dll.
                                        Misalnya di
                                        perusahaan P&amp;G, Unilever, Nestle, Astra, dll.
                                    </li>
                                    <li><strong>Bidang logistik</strong><br> Perencanaan dan pengelolaan sistem
                                        distribusi
                                        merupakan bidang yang mulai banyak dimasuki oleh lulusan TI seperti di P&amp;G,
                                        PT
                                        Semen Gresik, dll.
                                    </li>
                                    <li><strong>Bidang manajemen sumber daya manusia</strong><br> Pengelolaan sumber
                                        daya
                                    ...
                                    <li><strong>Bidang keuangan (bank dan asuransi)</strong><br> Misalnya BNI, Bank
                                        Mandiri,
                                        Bank Niaga, dsb.
                                    </li>
                                    <li><strong>Bidang konsultasi manajemen</strong><br> Misalnya Boston Consulting
                                        Group,
                        ...
                        <div class="tab-pane" id="kelautan">
                            <div class="timeline-item" id="kelautan_last"><h1><span
                                            style="color: #ff00ff;">Kelautan</span>
                                </h1>
