                                ...
                                <div style="position: relative;" class="amcharts-main-div">
                                    <div style="overflow: hidden; position: relative; text-align: left; width: 1623px; height: 400px; padding: 0px;"
                                        ...
                                        <svg version="1.1"
                                            ...
                                            <g>
                                                <path cs="100,100" d="M0.5,0.5 L1622.5,0.5 L1622.5,399.5 L0.5,399.5 Z"
                                            ...
                                            <g></g>
                                            <g>
                                                <g opacity="1" aria-label="Belanja Tidak Langsung: 4.96% 732,950,000 "
                                            ...
                                            <g>
                                                <g visibility="visible" transform="translate(0,0)" opacity="1">
                                                    <text y="6" fill="#000000" font-family="Verdana" font-size="11px"
                                                          opacity="1" text-anchor="start" transform="translate(975,131)"
                                                ...
                                                <g visibility="visible" transform="translate(0,0)" opacity="1">
                                                    <text y="6" fill="#000000" font-family="Verdana" font-size="11px"
                                                          opacity="1" text-anchor="end" transform="translate(729,301)"
                                                          style="cursor: default;" visibility="visible">
                                                ...
                                                <g visibility="visible" transform="translate(0,0)" opacity="1">
                                                    <text y="6" fill="#000000" font-family="Verdana" font-size="11px"
                                                          opacity="1" text-anchor="end" transform="translate(677,107)"
                                                          style="cursor: default;" visibility="visible">
                                                ...
                                                <g visibility="visible" transform="translate(0,0)" opacity="1">
                                                    <text y="6" fill="#000000" font-family="Verdana" font-size="11px"
                                                          opacity="1" text-anchor="end" transform="translate(772,76)"
                                                          style="cursor: default;" visibility="visible">
