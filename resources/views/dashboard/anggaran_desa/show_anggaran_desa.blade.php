	...
	<div class="row">
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="info-box bg-aqua">
				<span class="info-box-icon" id="in_dd_persen" style="font-size: 30px;"><i class="fa fa-money"></i></span>
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="info-box bg-green">
				<span class="info-box-icon" id="in_add_persen" style="font-size: 30px;"><i class="fa fa-money"></i></span>
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="info-box bg-yellow">
				<span class="info-box-icon" id="in_pad_persen" style="font-size: 30px;"><i class="fa fa-money"></i></span>
	...
	<div class="row">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="info-box bg-red">
				<span class="info-box-icon" id="in_bhpr_persen" style="font-size: 30px;"><i class="fa fa-money"></i></span>
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="info-box bg-aqua">
				<span class="info-box-icon" id="in_bantuan_kabupaten_persen" style="font-size: 30px;"><i class="fa fa-money"></i></span>
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="info-box bg-green">
				<span class="info-box-icon" id="in_bantuan_provinsi_persen" style="font-size: 30px;"><i class="fa fa-money"></i></span>
