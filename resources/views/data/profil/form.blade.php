<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               {!! Form::select('provinsi_id', [], 'S', ['class' => 'form-control', 'id' => 'provinsi_id' ]); !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               {!! Form::select('kabupaten_id', [], 'S', ['class' => 'form-control', 'id' => 'kabupaten_id' ]); !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               {!! Form::select('kecamatan_id', [], 'S', ['class' => 'form-control', 'id' => 'kecamatan_id' ]); !!}
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('kode_pos', null,['placeholder'=>'13210', 'class'=>'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('telepon', null,['placeholder'=>'021-4567890', 'class'=>'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('email', null,['placeholder'=>'021-4567890', 'class'=>'form-control']) !!}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               {!! Form::text('nama_camat', null,['placeholder'=>'Nama Camat', 'class'=>'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               {!! Form::text('sekretaris_camat', null,['placeholder'=>'Sekretaris Camat', 'class'=>'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               {!! Form::text('kepsek_pemerintahan_umum', null,['placeholder'=>'Kepala Seksi Pemerintahan Umum', 'class'=>'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('kepsek_kesejahteraan_masyarakat', null,['placeholder'=>'Kepala Seksi Kesejahteraan Masyarakat', 'class'=>'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('kepsek_pemberdayaan_masyarakat', null,['placeholder'=>'Kepala Seksi Pemberdayaan Masyarakat', 'class'=>'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('kepsek_pelayanan_umum', null,['placeholder'=>'Kepala Seksi Pelayanan Umum', 'class'=>'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('kepsek_trantib', null,['placeholder'=>'Kepala Seksi TRANTIB', 'class'=>'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">File Struktur Organisasi <span class="required">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="file" name="file_struktur_organisasi" class="form-control" >
            </div>
        </div>
    </div>
</div>
