...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('data.proses-domisili.index')}}">Proses Surat Domisili</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                {!! Form::open( [ 'route' => 'data.proses-domisili.store', 'method' => 'post','id' => 'form-domisili', 'class' => 'form-horizontal form-label-left'] ) !!}
                ...
                <div class="box-body">
                    ...
                    @include('data.proses_domisili.form_create')
