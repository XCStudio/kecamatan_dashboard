<div class="form-group">
    <label for="aki" class="control-label col-md-4 col-sm-3 col-xs-12">Nama <span class="required">*</span></label>
...
<div class="form-group">
    <label for="akb" class="control-label col-md-4 col-sm-3 col-xs-12">Nama <span class="required">*</span></label>
    ...
    <div class="col-md-8">
        <select class="form-control" id="bulan" name="bulan">
            @foreach(months_list() as $key=> $month)
                @if($akib->bulan == $month)
                <option selected="selected" value="{{$key}}">{{$month}}</option>
                @else
