...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('data.epidemi-penyakit.index')}}">AKI & AKB</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="well">
                                ...
                                <p>Silahkan download template upload data di sini: <a href="{{ asset('storage/template_upload/Format Upload Epidemi Penyakit.xlsx') }}">Download</a></p>
                            </div>
                        </div>
                    </div>
