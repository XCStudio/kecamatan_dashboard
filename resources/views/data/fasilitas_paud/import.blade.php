    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- form start -->
                {!! Form::open( [ 'route' => 'data.fasilitas-paud.do_import', 'method' => 'post','id' => 'form-import', 'class' => 'form-horizontal form-label-left', 'files' => true ] ) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="well">
                                ...
                                <p>Silahkan download template upload data di sini: <a href="{{ asset('storage/template_upload/Format_Upload_Failitas_PAUD.xlsx') }}">Download</a></p>
                            </div>
                        </div>
                    </div>
