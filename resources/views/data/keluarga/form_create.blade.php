        ...
        <div class="form-group">
            ...
            <div class="input-group col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-primary btn-sm @if(old('sex') == 1) active @endif">
                        <input type="radio" name="sex" id="jenis_kelamin" value="1" autocomplete="off" @if(old('sex') == 1) checked @endif> Laki-Laki
                    </label>
                    <label class="btn btn-primary btn-sm @if(old('sex') == 2) active @endif">
                        <input type="radio" name="sex" id="jenis_kelamin" value="2" autocomplete="off" @if(old('sex') == 2) checked @endif> Perempuan
                    </label>
                </div>
            </div>
        </div>
            ...
            <div class="input-group col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-primary btn-sm @if(old('status') == 1) active @endif">
                        <input type="radio" name="status" id="status" value="1" autocomplete="off" @if(old('status') == 1) checked @endif> Tetap
                    </label>
                    <label class="btn btn-primary btn-sm @if(old('status') == 2) active @endif">
                        <input type="radio" name="status" id="status" value="2" autocomplete="off" @if(old('status') == 2) checked @endif> Tidak Aktif
                    </label>
                    <label class="btn btn-primary btn-sm @if(old('status') == 3) active @endif">
                        <input type="radio" name="status" id="status" value="3" autocomplete="off" @if(old('status') == 3) checked @endif> Pendatang
                    </label>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="input-group col-md-6 col-sm-6 col-xs-12">
                ...
                &nbsp;
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-primary btn-sm @if(old('hamil') == 1) active @endif">
                        <input type="radio" name="hamil" id="hamil" value="1" autocomplete="off" @if(old('hamil') == 1) checked @endif> Tidak Hamil
                    </label>
                    <label class="btn btn-primary btn-sm @if(old('hamil') == 2) active @endif">
                        <input type="radio" name="hamil" id="hamil" value="2" autocomplete="off" @if(old('hamil') == 2) checked @endif> Hamil
                    </label>
                </div>
            </div>
        </div>
