        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    {!! Form::select('kategori_id', \App\Models\TipePotensi::pluck('nama_kategori', 'id'), $_GET['id'],['placeholder'=>'- Kategori', 'class'=>'form-control', 'id'=>'kategori_id', 'required'=>true, 'onchange'=>"changeCategori(this)"]) !!}
                  </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
